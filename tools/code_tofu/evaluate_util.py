...
from data_module import TextDatasetQA, CodeDataset, custom_data_collator, get_batch_loss, custom_data_collator_with_indices
import torch
...
def get_dataloader(cfg, eval_task, tokenizer, folder, split, question_key, answer_key, base_answer_key, perturbed_answer_key):
    ...
    if cfg.split == 'code':
        torch_format_dataset = CodeDataset( 
            folder, 
            tokenizer=tokenizer, 
        ...
        base_torch_format_dataset = CodeDataset(
            folder,
            tokenizer=tokenizer, 
            model_family=cfg.model_family, 
            max_length=cfg.generation.max_length, 
        ...
        perturb_torch_format_dataset = CodeDataset(
            folder,
            tokenizer=tokenizer, 
            model_family=cfg.model_family, 
            max_length=cfg.generation.max_length, 
