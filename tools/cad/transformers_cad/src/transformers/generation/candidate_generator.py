...
class AssistedCandidateGenerator(CandidateGenerator):
    ...
    def get_candidates(self, original_tokenizer, input_ids: torch.LongTensor) -> Tuple[torch.LongTensor, Optional[torch.FloatTensor]]:
        """
        Fetches the candidates to be tried for the current input.
        ...
        assistant_output = self.assistant_model.generate(original_tokenizer, **assistant_generation_kwargs, **self.assistant_kwargs)
