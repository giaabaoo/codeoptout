...
class EvaluateTakedownAtTraining:
    ...
    def run(self):
        ...
        ################## TAKING DOWN FORGET SET ##################        
        for sample in tqdm(data_loader.forget_items):
            prompt, gt = sample['prompt'], sample['gt']

            takedown_method.takedown_only(prompt, gt, LLM) # this will change the LLM parameters       
        
        time_end = timeit.default_timer()
        takedown_time = time_end - time_start
        print("Time taken for taking down forget set: ", takedown_time)
        ################## TAKING DOWN FORGET SET ##################
