B_INST = {"llama2": "[INST] ", "code": "", "dbrx": "<|im_start|>user\n", "llama3":"<|start_header_id|>user<|end_header_id|>\n\n"}
E_INST = {"llama2": " [/INST]", "code": "", "dbrx": "<|im_end|>\n<|im_start|>assistant\n", 'llama3': "<|eot_id|><|start_header_id|>assistant<|end_header_id|>\n"}
...
# SYS_BING = "You are a helpful, respectful and honest assistant. You must not reply with content that violates copyrights for code."
...
def get_prompt_template(prompt_template_style="base", eval_mode=False, model="llama2"):
    ...
    if prompt_template_style in ['none', 'sys_a', 'sys_b', 'sys_c', 'dbrx', 'copilot', 'bing', 'code', 'code_cpr']:
        ...
        elif prompt_template_style == 'code':
            # system_prompt = SYS_CODE
            system_prompt = ''
        elif prompt_template_style == 'code_cpr':
            system_prompt = SYS_CODE_CPR
        else:
            system_prompt = SYS
